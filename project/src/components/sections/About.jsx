    ...
    >
      ...
      >
        <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          skilled in Python, SQL, Machine Learning, and Data Analytics. I have hands-on experience 
          with Flask APIs, predictive analytics, and computer vision projects. I am proficient in 
          creating dashboards using Power BI and Tableau for data-driven insights, and have strong problem-solving skills.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-6">
          ...
          {/* 12th Grade */}
          <div className="space-y-3 border-t border-white/20 dark:border-gray-700/50 pt-4">
            <h4 className="text-lg md:text-xl font-medium text-gray-800 dark:text-white">
              Class XII (2021)
            </h4>
            <div className="flex items-center text-sm md:text-base text-gray-600 dark:text-gray-300">
              <MapPin size={16} className="mr-2" />
              <p>Aditya Junior College</p>
            </div>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
              <span className="text-sm md:text-base text-gray-600 dark:text-gray-300">Percentage: 89.6%</span>
              <span className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-3 py-1 rounded-full text-xs md:text-sm font-medium w-fit">
                2021
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3 border-t border-white/20 dark:border-gray-700/50 pt-4">
            ...
            <div className="flex items-center text-sm md:text-base text-gray-600 dark:text-gray-300">
              <MapPin size={16} className="mr-2" />
              <p>Atimya VidyaPeeth</p>
            </div>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
              <span className="text-sm md:text-base text-gray-600 dark:text-gray-300">Percentage: 80%</span>
              <span className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-3 py-1 rounded-full text-xs md:text-sm font-medium w-fit">
                2019
              </span>
            </div>
          </div>
