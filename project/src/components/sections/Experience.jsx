  ...
  const experiences = [
    {
      ...
      location: "India",
      description: [
        "Developed data-driven solutions using MySQL, Networking, and Python.",
        "Engineered AI and ML projects to optimize predictive analytics."
      ],
    ...
    },
    {
      ...
      location: "India",
      description: [
        "Mastered machine learning algorithms to enhance prediction accuracy.",
        "Applied practical expertise within structured project environments."
      ],
    ...
    },
    {
      ...
      location: "India",
      description: [
        "Devised ML models using Python and TensorFlow.",
        "Conducted data preprocessing and model evaluations."
      ],
