...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description: "Utilized Random Forest to enhance model accuracy for diabetes classification.",
      tech: ["Random Forest", "Python", "Machine Learning"],
      status: "Completed"
    },
    {
      title: "Movie Classification Review",
      date: "Apr 2024 - Apr 2024", 
      description: "Evolved a review classification model using Gaussian Distribution Network for sentiment analysis.",
      tech: ["Gaussian Distribution Network", "NLP", "Python"],
      status: "Completed"
    },
    {
      title: "Ignite Guard (IoT)",
      date: "Apr 2024",
      description: "A smart, connected system for real-time gas leak detection and safety alerts.",
      tech: ["IoT", "Python", "Sensors"],
      status: "Completed"
    },
    {
      title: "ECG Prediction Using ML",
      date: "Sep 2023 - Sep 2023",
      description: "Developing an AI model to analyze ECG signals and predict cardiac abnormalities.",
    ...
    },
    {
      ...
      description: "Enhanced a predictive model by sourcing and analyzing datasets using foundational AI algorithms.",
